...
class CompareGeneContent(object):
    ...
    def compare_gene_content(self, workspace_name, model_id, matrix_id, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method compare_gene_content: argument json_rpc_context is not type dict as required.')
        resp = self._call('CompareGeneContent.compare_gene_content',
                          [workspace_name, model_id, matrix_id], json_rpc_context)
        return resp[0]
